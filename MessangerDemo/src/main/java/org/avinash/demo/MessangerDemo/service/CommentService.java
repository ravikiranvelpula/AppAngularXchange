...
public class CommentService {
	...
	public String UpdateComment(@PathParam("commentId") String commentId,CommentEntity comment) throws JsonGenerationException, JsonMappingException, IOException{
